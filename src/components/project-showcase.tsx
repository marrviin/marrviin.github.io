...
/** Link icons — 14px thin-stroke marks matching the paper-line aesthetic. */
function IconLaunch() {
  return (
    <svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">
      <g
        ...
        fill="none"
      >
        <path d="M6.5 3.5H3.2c-.4 0-.7.3-.7.7v8.6c0 .4.3.7.7.7h8.6c.4 0 .7-.3.7-.7V9.5" />
        <path d="M9.5 2.5h4v4" />
